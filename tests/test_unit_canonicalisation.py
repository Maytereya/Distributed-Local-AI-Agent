...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Сердечно-сосудистый хирург — своя ординатура, НЕ general хирург.
        # Класс тот же, что пластический хирург/нейрохирург: уточнённый профиль
        # не отвечает на запрос базовой специальности.
        ("Врач-сердечно-сосудистый хирург, флеболог", "хирург"),
        ("Врач-сердечно-сосудистый хирург, флеболог, лимфолог", "хирург"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # — composite из живого кэша: перечисление ролей через запятую —
        # «Врач-сердечно-сосудистый хирург, флеболог[, лимфолог]» отвечает на
        # КАЖДУЮ перечисленную роль (флеболог/лимфолог — равноправные), но не
        # на базовый «хирург» (см. блок 1).
        ("Врач-сердечно-сосудистый хирург, флеболог", "сердечно-сосудистый хирург"),
        ("Врач-сердечно-сосудистый хирург, флеболог", "флеболог"),
        ("Врач-сердечно-сосудистый хирург, флеболог, лимфолог", "флеболог"),
        ("Врач-сердечно-сосудистый хирург, флеболог, лимфолог", "лимфолог"),
        # — синонимы / расширения —
...
def test_canonical_targets_subset_of_specialty_canonical() -> None:
    ...
    extras = {
        ...
        "сердечно-сосудистый хирург",  # отдельная специальность из live-кэша, ещё не в enum
    }
