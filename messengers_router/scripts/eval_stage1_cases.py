...
Ответственность скрипта: smoke-проверка базовой маршрутизации по контрольным кейсам.
"""
...
CASES: list[Case] = [
    ...
    # Решение владельца 14.08: отмена существующей записи НЕ ведёт в сценарий
    # записи — бот распознаёт намерение и предлагает оператора вопросом.
    Case("A3", "Отмените прием у невролога", "OTHER", False),
    ...
    Case("C1", "Мне нужна справка для налогового вычета", "OTHER", False),
