...
FLOWS: list[Flow] = [
    ...
    Flow(
        ...
        steps=[
            ...
            # Адрес обновлён в мае 2026: «ул. Победы, 83» больше нет в списке филиалов
            # Трубина в CRM, а сценарий хардкодит ответ пациента. Берём актуальный филиал.
            Step("г. Самара, ул. Гагарина, 12", ("дату и время", "на какую дату", "удобное время"), False),
